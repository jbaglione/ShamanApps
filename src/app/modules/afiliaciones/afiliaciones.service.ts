...
export class AfiliacionesService {
  ...
  getVendedores(): Observable<listable[]> {
    return this.httpClient.get<listable[]>(this.vendedoresApiUrl)
            .pipe(
              shareReplay(),
  ...
  getClientePotencial(tipoCliente: string, vendedor: string): Observable<ClientePotencial[]> {
        ...
        const headerOptions = new HttpHeaders({ 'Content-Type': 'application/json',
                                                ...
                                                'Vendedor': `${vendedor}` });
        return this.httpClient.get<ClientePotencial[]>(url, { headers: headerOptions })
                .pipe(
                    shareReplay(),
    ...
    getContrato(clienteId: number) {
        ...
        return this.httpClient.get<any>(url, { headers: headerOptions })
                .pipe(
                  shareReplay(),
